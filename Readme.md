...
Demo [https://six-cities-9.netlify.app/](https://six-cities-9.netlify.app/)
...
## [1.](https://up.htmlacademy.ru/react/9/project/six-cities#func) Описание функциональности

### [1.1.](https://up.htmlacademy.ru/react/9/project/six-cities#pages) Страницы приложения
...
#### [1.1.1.](https://up.htmlacademy.ru/react/9/project/six-cities#mainPage) Главная страница
...
##### [1.1.1.1.](https://up.htmlacademy.ru/react/9/project/six-cities#mainPageOfferList) Список предложений
...
##### [1.1.1.2.](https://up.htmlacademy.ru/react/9/project/six-cities#map) Карта
...
#### [1.1.2.](https://up.htmlacademy.ru/react/9/project/six-cities#offerPage) Страница предложения
...
##### [1.1.2.1.](https://up.htmlacademy.ru/react/9/project/six-cities#offerPageReviews) Отзывы
...
##### [1.1.2.2.](https://up.htmlacademy.ru/react/9/project/six-cities#offerPageReviewForm) Форма отправки отзыва
...
#### [1.1.3.](https://up.htmlacademy.ru/react/9/project/six-cities#pageSignIn) Страница Sign In
...
#### [1.1.4.](https://up.htmlacademy.ru/react/9/project/six-cities#pageFavorites) Favorites
...
-   Данные для страницы «Favorites» всегда загружаются с сервера. Для этого предусмотрен отдельный маршрут (см. раздел «[Взаимодействие с сервером](https://up.htmlacademy.ru/react/9/project/six-cities)»).
...
#### [1.1.5.](https://up.htmlacademy.ru/react/9/project/six-cities#other) Разное
...
## [2.](https://up.htmlacademy.ru/react/9/project/six-cities#server) Взаимодействие с сервером

-   Все необходимые данные загружаются с сервера.
-   Сервер доступен по адресу: `https://9.react.pages.academy/six-cities`.
-   Спецификация по взаимодействию с сервером в формате OpenAPI — [https://9.react.pages.academy/six-cities/spec](https://9.react.pages.academy/six-cities/spec).
